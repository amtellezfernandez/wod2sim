...
STUDY_ROOT="${WOD2SIM_WAYMAX_STUDY_ROOT:-$ROOT/workspace/waymax-contract-study}"
...
OUTPUT="${WOD2SIM_WAYMAX_OUTPUT:-$ROOT/artifacts/external/waymax_contract_study}"
...
"$VENV/bin/python" -m wod2sim.experiments.waymax_contract_study \
