...
from alpabridge.audit.trace_diagnostics import DEFAULT_CONTEXT, diagnose_contract_trace
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description=(
            "Run the AlpaBridge route-contract ablation on Waymax's pinned 20-scenario "
            "WOMD fixture."
        )
    )
    parser.add_argument(
    ...
    *,
    ...
    summary = {
        ...
        "dataset": {
            ...
            "raw_records_redistributed_by_alpabridge": False,
        },
        "design": {
            "scientific_question": (
...
def _implementation_hashes() -> dict[str, str]:
    ...
    paths = (
        Path("src/alpabridge/experiments/waymax_contract_study.py"),
        Path("src/alpabridge/audit/trace_diagnostics.py"),
