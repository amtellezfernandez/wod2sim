...
class BenchmarkRegenerationReadinessTests(unittest.TestCase):
    ...
    def test_tracked_readiness_snapshot_is_public_safe_and_records_remaining_scale_gap(
        ...
        self.assertEqual(10, stages[50]["source_usdz_cache"]["usdz_file_count"])
        self.assertEqual(0, stages[50]["source_usdz_cache"]["matching_scene_count"])
        self.assertEqual(10, stages[50]["source_usdz_cache"]["nonmatching_usdz_file_count"])
        ...
        self.assertEqual(10, stages[100]["source_usdz_cache"]["usdz_file_count"])
        self.assertEqual(0, stages[100]["source_usdz_cache"]["matching_scene_count"])
        self.assertEqual(10, stages[100]["source_usdz_cache"]["nonmatching_usdz_file_count"])
