...
class AggregateCVMTests(unittest.TestCase):
    ...
    @unittest.skip(
        "artifacts/external/alpasim_protocol_replay/manifest.json records source paths "
        "under src/wod2sim/... from before the WOD2Sim->AlpaBridge package rename; those "
        "paths no longer resolve, so this frozen evidence can no longer be revalidated "
