...
| `./scripts/build_cvm_paper.sh` | Passed: rebuilt the 6-page, 207253-byte A4 `wod2sim.pdf`. |
...
| `pdfinfo wod2sim.pdf` | 6 portrait A4 pages, 207253 bytes, expected title/author/subject metadata. |
