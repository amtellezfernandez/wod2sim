...
| `uv run python -m pytest --cov` | 367 passed, 14 skipped; total coverage 65.31% against the configured 33.0% minimum. |
...
| `./scripts/build_cvm_paper.sh` | Passed: rebuilt the 6-page, 203787-byte A4 `wod2sim.pdf`. |
...
| `pdfinfo wod2sim.pdf` | 6 portrait A4 pages, 203787 bytes, expected title/author/subject metadata. |
...
| Selection | Result |
|---|---|
| `tests -k "semantic or route"` | 20 passed, 361 deselected. |
| `tests -k "temporal or resampl"` | 15 passed, 366 deselected, 15 subtests passed. |
| `tests -k "lifecycle or session"` | 20 passed, 361 deselected. |
| `tests -k "plugin or entry_point"` | 6 passed, 375 deselected. |
| `tests -k "deployment or readiness or launch"` | 23 passed, 358 deselected. |
| `tests -k "evidence or audit or benchmark"` | 33 passed, 348 deselected. |
| `tests -k "fault"` | 13 passed, 368 deselected. |
