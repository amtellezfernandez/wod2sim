...
| `make conformance PYTHON='uv run python'` | Passed through `make verify`: 306 passed, 14 skipped, 15 subtests passed. |
| `make demo PYTHON='uv run python'` | Passed: synthetic demo valid with `valid_claim_evidence=false`. |
| `make cvm-check PYTHON='uv run python'` | Passed: ruff clean, 306 passed, 14 skipped, 15 subtests passed, validation passed. |
...
| `uv run python -m pytest -q` | Passed through `make verify`: 306 passed, 14 skipped, 15 subtests passed. |
| `uv run python -m pytest --cov` | Passed through `make verify`: 306 passed, 14 skipped, total coverage 62.45% against the configured 33.0% minimum. |
...
| Selection | Result |
|---|---|
| `tests -k "semantic or route"` | 10 passed, 310 deselected. |
| `tests -k "temporal or resampl"` | 10 passed, 310 deselected, 15 subtests passed. |
| `tests -k "lifecycle or session"` | 10 passed, 310 deselected. |
| `tests -k "plugin or entry_point"` | 5 passed, 315 deselected. |
| `tests -k "deployment or readiness or launch"` | 20 passed, 300 deselected. |
| `tests -k "evidence or audit or benchmark"` | 27 passed, 293 deselected. |
| `tests -k "fault"` | 5 passed, 315 deselected. |
